...
indice_onde_tab %>%
  ...
  ggplot2::labs(x = paste0("Années de campagnes ONDE (mois de ", mois_sel,")"), y = "Valeurs d'indice",
                caption = paste0("Données Onde, au ", Sys.Date()),
                title = paste0("Notes d'indice pour le département (", mois_sel," 2012 - ",lubridate::year(Sys.Date()),")")) +
