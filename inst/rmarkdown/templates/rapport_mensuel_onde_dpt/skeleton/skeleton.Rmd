...
lib_mois <- format(lubridate::ym(annee_mois), "%m")
...
indice_onde_tab %>%
  ...
  ggplot2::labs(x = paste0("Années de campagnes ONDE (mois de ", mois,")"), y = "Valeurs d'indice",
                caption = paste0("Données Onde, au ", Sys.Date()),
                title = paste0("Notes d'indice pour le département (", mois," 2012 - ",lubridate::year(Sys.Date()),")")) +
