...
mois <- format(lubridate::ym(annee_mois), "%m")

produire_barplot_region_par_dpt(mois_sel = mois,
...
indice_onde_tab %>%
  ...
  ggplot2::labs(x = paste0("Années de campagnes ONDE (mois de ", format(date_campagne, "%m"),")"), y = "Valeurs d'indice",
                caption = paste0("Données Onde, au ", Sys.Date()),
                title = paste0("Notes d'indice pour le département (", format(date_campagne, "%m")," 2012 - ",lubridate::year(Sys.Date()),")")) +
